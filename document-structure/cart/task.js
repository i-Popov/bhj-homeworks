...
for (let product of products) {
    ...
    decButton.addEventListener("click", () => {
        ...
        if(orderedAmount > 1) {
            valueButton.innerHTML = Number(orderedAmount - 1)
        }
    })
    ...
    addButton.addEventListener("click", () => {
        ...
        if (!checkId) {
            ...
            checkId.querySelector(".cart__product-count").textContent = Number(checkId.querySelector(".cart__product-count").textContent) + Number(valueButton.textContent);
        }
